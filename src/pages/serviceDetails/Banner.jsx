...
const Banner = () => {
  return (
    ...
    <div className="bg-[#1d1c1cb2] w-full h-full rounded-lg flex flex-col justify-center">
        <h1 className="md:text-5xl text-3xl text-white font-bold md:ml-20 ml-3">Service Details</h1>
    </div>
    <div className="bg-[#FF3811] text-white font-bold w-60 text-center absolute bottom-0 py-5 rounded-t-full">Home/Service Details</div>
  </div>
  )
}
