    ...
    <div className="mb-20 px-3">
      ...
      <div className="flex xl:flex-row flex-col gap-5">
        ...
        <div className="flex-1 space-y-5">
          ...
          />
          <h3 className="text-3xl font-bold">Unique Car Engine Service</h3>
          <p className="text-[#737373] text-justify">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
            <ServiceDetailsFeatureCard></ServiceDetailsFeatureCard>
            <ServiceDetailsFeatureCard></ServiceDetailsFeatureCard>
            <ServiceDetailsFeatureCard></ServiceDetailsFeatureCard>
            <ServiceDetailsFeatureCard></ServiceDetailsFeatureCard>
          </div>
          ...
          <div>
            <img className="rounded-lg" src={serviceImg} alt="footer image" />
          </div>
        </div>

        {/* Right Sidebar  */}
        <div className="space-y-10 md:min-w-[300px]">
          {/* services  */}
          <div className="bg-[#F3F3F3] rounded-lg px-5 py-10 space-y-5 border-[1px] border-solid border-[#ff391134]">
          ...
          {/* downloads area  */}
          <div className="bg-[#151515] rounded-lg md:p-5 p-2 text-white space-y-5">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">Our Brochure</h3>
                  <p className="text-gray-300">Download</p>
                </div>
              </div>
              <div className="text-2xl bg-[#FF3811] px-3 py-2 rounded-md cursor-pointer">
          ...
          {/* savings area  */}
          <div className="bg-[#151515] px-5 py-16 rounded-lg text-white space-y-5 text-center">
            <div className="flex justify-center flex-col items-center gap-3">
              ...
              <h3 className="text-2xl text-white font-bold">Car Doctor</h3>
            </div>
            <p className="font-bold">
              Need Help? We Are Here <br /> To Help You
            </p>
            {/* bage  */}
            <div className="bg-[#FFFFFF] rounded-lg px-3 py-7 font-bold flex flex-col items-center justify-center relative">
              <p>
                <span className="text-[#FF3811]">Car Doctor </span>
                <span className="text-gray-800">Special</span>
              </p>
              <p>
                <span className="text-gray-500">Save up to</span>{" "}
                <span className="text-[#FF3811]">60% off</span>
              </p>
              <div className="bg-[#FF3811] absolute p-3 rounded-lg bottom-[-26px]">
