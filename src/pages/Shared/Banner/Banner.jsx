...
const Banner = ({bannerInfo}) => {
  const {title, path, img} = bannerInfo;
  return (
    <div className="h-96 rounded-lg mb-20 relative flex flex-col justify-center items-center" style={{backgroundImage: `url(${img})`, backgroundSize:'100% 100%', backgroundRepeat:'no-repeat'}}>
